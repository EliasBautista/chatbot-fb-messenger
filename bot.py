...
class Bot(object):
    ...
    def handle(self, user_id, user_message, is_admin=False):
        ...
        # 	(u'Info. del proyecto', 'user'),
        # 	(u'Este es un proyecto para la asignatura de Paradigmas de Programación', 'bot'),
        # 	(u'Python', 'user'),
        # 	(u'Para este proyecto se utilizo la versión 2.7.18 de Python, consulta la documentación :)', 'bot'),
        # 	(u'abc', 'user'),
