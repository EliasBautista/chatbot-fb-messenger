...
ACCESS_TOKEN = "EAAgTy0wYDxwBADCWbXZCAXTPhPyvQFRXe61Ln2pBpFw3H5YZBLrZCmvAIJ7NZCRHSBqyX2lyB7IPzUIeyrBm6IafufqVK2ky7CAZAMseWyVUfNNwcFXmqRLn4zOPXD6QmDx3aiLyLb1frQdWEBOZB2vy5ZAwfnXQVjUtcvZC50i7UAZDZD"
...
class MainPage(webapp2.RequestHandler):
    def __init__(self, request=None, response=None):
        ...
        tree = yaml.load(open('Chatbot tree.yaml'))
